...
docker exec -it namenode /bin/bash -c "bash /root/pig/bin/pig -x mapreduce /input/DetailsArbres.pig"

docker exec -it namenode /bin/bash -c "hdfs dfs -cat /user/hadoop/arbres-out/part-r-00000"
